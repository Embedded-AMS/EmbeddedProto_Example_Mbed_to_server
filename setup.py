...
def generate_source_code():
    ...
    try:
        ...
        command = ["protoc", "-I../proto", "--eams_out=../nucleo-f767zi/generated", 
                   "../proto/eth_messages.proto"]
        ...
        result = subprocess.run(["protoc", "-I./proto", "--python_out=./desktop/generated", 
                                 "./proto/eth_messages.proto"], check=False, capture_output=True)
        if result.returncode:
            print(" [" + CRED + "Fail" + CEND + "]")
            print(result.stderr.decode("utf-8"), end='', file=stderr)
            exit(1)
...
if __name__ == "__main__":
    ...
    newpath = r"./nucleo-f767zi/generated"
