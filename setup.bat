...
:: Copy embedded proto source files to Mbed project
if not exist ".\nucleo-f767zi\EmbeddedProtoSrc" mkdir .\nucleo-f767zi\EmbeddedProtoSrc
xcopy /s /y EmbeddedProto\src\*.* nucleo-f767zi\EmbeddedProtoSrc\
